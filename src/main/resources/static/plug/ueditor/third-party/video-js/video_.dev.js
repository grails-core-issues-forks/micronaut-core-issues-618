...
================================================================================ */
/**
 * The common functionality for sliders like the volume bar and seek bar
 *
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Run common component initializing with new options.
...
/**
 * The common class for all text tracks
 *
...
/**
 * The common class for buttons that toggle specific text track types (e.g. subtitles)
 *
 * @constructor
 */
