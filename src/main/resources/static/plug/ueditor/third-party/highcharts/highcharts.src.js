...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// pull out the common lines before padding
		if (elem.isArea) {
		...
		if (startBaseLine) { // append the common lines for areas
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		return extend(wrapper, {
			...
			destroy: function () {
				...
				// Call common implementation to destroy the rest
...
/**
 * The Point object and prototype. Inheritable and used as common for PiePoint
 */
var Point = function () {};
Point.prototype = {
...
/**
 * @classDescription The common function which all other series types inherit from. The data in the series is stored
 * in various arrays.
 *
...
var AreaSeries = extendClass(Series, {
	...
	/**
	 * Extend the common Series getSegmentPath method by adding the path for the area.
	 * This path is pushed to the series.areaPath property.
	 */
	getSegmentPath: function (segment) {
		
		var segmentPath = Series.prototype.getSegmentPath.call(this, segment), // call common method
	...
	/**
	 * Draw the graph and the underlying area. This method calls the Series common
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	groupPadding: 0.2,
	//grouping: true,
	marker: null, // point options are specified in the common options
	pointPadding: 0.1,
	//pointWidth: null,
	minPointLength: 0,
...
var PieSeries = {
	...
	/**
	 * Override the common drawDataLabels method by pie specific functionality
	 */
	drawDataLabels: function () {
		var series = this,
			data = series.data,
		...
		each(data, function (point) {
			if (point.dataLabel) { // it may have been cancelled in the common method (#407)
